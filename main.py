...
# sc.get_categories('https://www.goodreads.com/genres/', '//span[text()="Browse ▾"]', '//ul[contains(@class, "genreList")]//li/a')
# print(sc.categories)
# # sc.generate_urls()
...
sc.visit_urls(stop=1)
sc.visit_items()
formated_data = sc.format_data()
sc.to_csv('./data/data.csv', formated_data)

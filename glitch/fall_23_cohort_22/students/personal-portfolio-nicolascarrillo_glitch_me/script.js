...
// let sidebarOpen = false; // Keep track of sidebar state
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Display the greeting for 3 seconds
    setTimeout(function () {
        ...
        if (greeting) {
            ...
            // Scroll to the top of the second page content (main content)
            setTimeout(function () {
                ...
                // Remove the loading section after scrolling
